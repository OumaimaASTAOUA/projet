            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="add.php" class="btn " style="background: #1f8fc3;color:aliceblue"><b>Add New Client+</b></a>
                        </div>
                    </div>
                </div>
...
<tr>
    ...
    <td><a href="updateC.php?id_client=<?php   echo $v["id_client"] ?>" class="btn btn-success">update</a></td>
    <td><a href="deleteC.php?id_client=<?php   echo $v["id_client"] ?>" class="btn btn-danger">delete</a></td>
