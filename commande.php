            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="addP.php" class="btn " style="background: #1f8fc3;color:aliceblue"><b>+Add New commande</b></a>
                        </div>
                    </div>
                </div>
...
<tr>
    <td><?php echo $v["numC"] ?></td>
    <td><?php echo $v["dateC"] ?></td>
    <td><?php echo $v["tempsC"] ?></td>
    <td><?php echo $v["id_client"] ?></td>
    <td><a href="update.php?numC=<?php   echo $v["numC"] ?>" class="btn btn-success">update</a></td>
    <td><a href="delete.php?numC=<?php   echo $v["numC"] ?>" class="btn btn-danger">delete</a></td>
