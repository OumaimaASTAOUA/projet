...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <h2>Update Client</h2>
            <form action="ajouterU.php" method="post" class="container mt-5">
        <label for="">nom</label>
        <input type="text" class="form-control" name="nom" value="<?php echo $nom ;?>">
        <label for="">email</label>
        <input type="text" class="form-control" name="prix" value="<?php echo $email ;?>">
        <label for="">adress</label>
        <input type="text" class="form-control" name="date" value="<?php echo $adress ;?>">
        <label for="">phone</label>
        <input type="text" class="form-control" name="date" value="<?php echo $phone ;?>"><br>
        <input type="submit" class="btn btn-primary" value="update" name="ajouterU">
    </form>
</body>
